...
AnfibioExotico::AnfibioExotico(string linhaCSV){
...
ostream& operator<< (ostream &o, AnfibioExotico const a) {
    ...
    o << "\tTotal de mudas: " << (a.total_de_mudas != -1 ? to_string(a.total_de_mudas) : "") << endl;
...
string AnfibioExotico::getStringFormatoCSV(){
	stringstream ss;
	ss << id << ";";
	ss << classe << ";";
    ss << nome_cientifico << ";";
